...
class HttpService(UtilService):
    ...
    def generate_config(cls, node: CoreNode, filename: str) -> str:
        ...
        if filename == cls.configs[0]:
            ...
            return cls.generatetext(node, filename)
        else:
            return ""
...
"""
    ...
    @classmethod
    def generatetext(cls, node: CoreNode, filename: str) -> str:
        body = (
            """\
<!-- generated by utility.py:HttpService -->
# %s web server
...
"de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 
45 BC.
#--<*END*>--#
"""
            % node.name
